...
func ExampleBR() {
	core.Dump(elem.Bundle{text.Text("Line 1"), text.BR(), text.Text("Line 2")})
	// Output: Line 1<br/>Line 2
}

func ExampleHR() {
	core.Dump(elem.Bundle{text.P()(text.Text("Section 1")), text.HR(), text.P()(text.Text("Section 2"))})
...
func ExampleSub() {
	core.Dump(elem.Bundle{text.Text("H"), text.Sub()(text.Text("2")), text.Text("O")})
	// Output: H<sub>2</sub>O
}

func ExampleSup() {
	core.Dump(elem.Bundle{text.Text("E=mc"), text.Sup()(text.Text("2"))})
