...
func ExampleEmbed() {
	core.Dump(object.Embed(core.Attribute("src", "plugin.swf"), object.Type("application/x-shockwave-flash")))
	// Output: <embed src="plugin.swf" type="application/x-shockwave-flash"/>
}

func ExampleParam() {
	core.Dump(object.Object(object.Data("movie.swf"),
		object.Param(object.Name("autoplay"), core.Attribute("value", "true")),
	))
