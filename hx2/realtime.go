...
func SSEConnect(url string) core.Node { return core.Attribute("sse-connect", url) }

// SSESwap sets the sse-swap attribute to specify which SSE message triggers a swap.
// Use with hx-ext="sse" on the element or a parent.
func SSESwap(messageName string) core.Node { return core.Attribute("sse-swap", messageName) }

// SSEClose sets the sse-close attribute to close the connection on a specific message.
// Use with hx-ext="sse" on the element or a parent.
func SSEClose(messageName string) core.Node { return core.Attribute("sse-close", messageName) }
...
func WSConnect(url string) core.Node { return core.Attribute("ws-connect", url) }
...
func WSSend() core.Node { return core.BoolAttribute("ws-send") }
